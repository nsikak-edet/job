...
<div class="as-mainwrapper">
    ...
    <div class="bg-white">
        ...
        <div class="breadcrumb-banner-area pt-94 pb-85 bg-3 bg-opacity-dark-blue-90" style="padding-top:20px;padding-bottom:20px;">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="breadcrumb-text">
                            <h2 class="text-center text-white uppercase mb-17"><?php echo @$page_title; ?></h2>
                            <div class="breadcrumb-bar">
                                <ul class="breadcrumb text-center m-0">
                                    <li class="text-white uppercase ml-15 mr-15"><a href="<?php echo base_url(); ?>"><?php echo @$page_title; ?></a></li>
                                    <li class="text-white uppercase ml-15 mr-15"><?php echo @$sub_page_title; ?></li>
                                </ul>
                            </div>
                        </div>
                    </div>
