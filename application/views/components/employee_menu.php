            ...
            <ul class="main-menu text-right">
                ...
                <li><a href="<?php echo base_url() ?>employee/"><i class="fa fa-level-down text-left"></i> My Account </a>
                    <ul class="dropdown">
                        ...
                        <li><a href="<?php echo base_url() ?>recruiter/"><i class="fa fa-files-o text-left"></i>Applications</a></li>
...
<!--            <a class="modal-view button" href="--><?php //echo base_url(); ?><!--recruiter/register">Recruiting?</a>-->
<!--        </div>-->
    </div>
</div>